<template>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-lg-3 col-xs-12">
                ...
                <div class="card m-b-20">
                    ...
                    <img class="img-fluid" src="../../images/gallery/12.jpg" alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text">Some quick example text to build on the card title and make
                            up the bulk of the card's content.</p>
                        <a href="#" class="card-link">Card link</a>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="card m-b-20">
                    ...
                    <img class="card-img-bottom img-fluid" src="../../images/gallery/2.jpg" alt="Card image cap">
                </div>
            </div>

            <div class="col-sm-4 col-xs-12">
                <div class="card m-b-20 card-inverse text-white">
                    <img class="card-img img-fluid" src="../../images/gallery/3.jpg" alt="Card image">
        ...
        <div class="row">
            <div class="col-sm-4 col-xs-12">
                <div class="card m-b-20 text-white bg-info text-xs-center">
                    <div class="card-body">
                        <blockquote class="card-bodyquote">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                erat a ante.</p>
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="card m-b-20 text-white bg-warning text-xs-center">
                    <div class="card-body">
                        <blockquote class="card-bodyquote">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                erat a ante.</p>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-group">
                    ...
                    <div class="card m-b-20">
                        <img class="card-img-top img-fluid" src="../../images/gallery/11.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a
            ...
            <div class="col-12">
                ...
                <div class="card-deck-wrapper">
                    <div class="card-deck">
                        ...
                        <div class="card m-b-20">
                            <img class="card-img-top img-fluid" src="../../images/gallery/12.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
