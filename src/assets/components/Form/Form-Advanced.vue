                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="m-b-0">
                                &lt;!&ndash;<select multiple data-role="tagsinput">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    &lt;!&ndash;<select multiple="multiple" class="multi-select" id="my_multi_select1" name="my_multi_select1[]" data-plugin="multiselect">
                    ...
                    <h6 class="m-t-30">Grouped Options</h6>
                    <p class="text-muted m-b-15 font-13">
                        Use a <code>
                        &lt;select multiple /&gt;</code>
                        as your input element for a tags input, to gain true multivalue support.
                    ...
                    &lt;!&ndash;<select multiple="multiple" class="multi-select" id="my_multi_select2" name="my_multi_select2[]" data-plugin="multiselect" data-selectable-optgroup="true">
                    ...
                    &lt;!&ndash;<select name="country" class="multi-select" multiple="" id="my_multi_select3" >
            ...
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    <h6 class="m-t-30">Multiple Select</h6>

                   &lt;!&ndash; <select class="select2 select2-multiple" multiple="multiple" multiple data-placeholder="Choose ...">
                        <optgroup label="Alaskan/Hawaiian Time Zone">
                            <option value="AK">Alaska</option>
                            <option value="HI">Hawaii</option>
                        </optgroup>
                    ...
                    <h6 class="m-t-30">Limiting the number of selections</h6>

                    &lt;!&ndash;<select class="select2-limiting" multiple="multiple">
                        <optgroup label="Alaskan/Hawaiian Time Zone">
                            <option value="AK">Alaska</option>
                            <option value="HI">Hawaii</option>
                        </optgroup>
