            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="message-box">
                        <h1 class="m-b-0">403</h1>
                        <h5>Sorry, access denied.</h5>
                        <div class="buttons-con">
                            <div class="action-link-wrap">
                                <router-link :to="{name: 'login'}"  class="btn btn-custom btn-primary waves-effect waves-light m-t-20">Go Back</router-link>
                                <router-link :to="{path: '/'}" class="btn btn-custom btn-primary waves-effect waves-light m-t-20">Go to Home Page</router-link>
                            </div>
                        </div>
                    </div>
                </div>
